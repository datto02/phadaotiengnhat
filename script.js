...
<div className="pt-4 border-t border-gray-100">
    ...
    >
        ...
        <span className="text-xs font-black tracking-wide uppercase">Tạo Flashcard</span>
            ...
            {/* --- NÚT MỚI: DANH SÁCH ÔN TẬP (SRS LIST) --- */}
<div className="pt-2 mt-1">
    <button 
        onClick={() => {
            onOpenReviewList();    // Gọi hàm mở Modal Danh sách
            setIsUtilsOpen(false); // Đóng menu Tiện ích lại
        }}
        className="w-full py-2.5 bg-white border border-gray-200 text-gray-600 hover:text-orange-600 hover:border-orange-300 hover:bg-orange-50 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 group shadow-sm"
    >
        {/* Icon Lịch/Danh sách */}
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 group-hover:text-orange-500 transition-colors">
        ...
        <span className="text-xs font-bold uppercase tracking-wide">Danh sách ôn tập</span>
    </button>
</div>
                        </div>
                    )}
